...
class GivenPermissionsAdapter(private  var permissions: ArrayList<Permission>) : BaseAdapter()
{
    @SuppressLint("ViewHolder")
    override fun getView(pos: Int, convertView: View?, parent: ViewGroup?): View =
        LayoutInflater.from(parent!!.context).inflate(R.layout.item, parent, false).apply {
            findViewById<ConstraintLayout>(R.id.item_extra).addView(inflate(parent.context, R.layout.extra_given_permission, null).apply {
